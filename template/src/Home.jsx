      ...
      <nav className="relative overflow-hidden flex row w-full h-24 bg-[#282a36] subpixel-antialiased z-50">
        ...
        <div className="flex-col w-full h-full justify-items-center">
          <ul className="flex row h-[10px] py-10 font-medium">
            <a href="#" className="text-white mr-[3em]">Home</a>
            <a href="/Dashboard" className="text-white mr-[3em]">Dashboard</a>
            <a href="#" className="text-white mr-[3em]">Features</a>
            <a href="#" className="text-white shrink-0">About us</a>
          </ul> 
          <div className="bg-[#dc96ff] w-12 h-2 rounded-[30px]"></div>
        </div>
        <div className="w-full justify-items-center text-center">
          <div className="my-10 mx-48 p-0.5 h-[2rem] w-[5rem] bg-[#fff] rounded" ><a className="place-self-center text-black font-medium font-sans text-sm">Login</a></div>
        </div>
      </nav>
