...
export const RegisterPage = () => {
    ...
    const submitHandler = async () => {
        ...
        if (!name) return toast.error("name not provided")
            ...
            <div className="pt-32 flex-col">
                ...
                <div className="">
                    ...
                    <div className="flex mb-5 border-2 border-black border-opacity-25">
                        ...
                        <input size={30} className="focus:outline-none" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="" type={showPassword ? "password" : "text"} />
